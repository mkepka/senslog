	...
	protected void doGet(HttpServletRequest request,
		...
		params.setUSER(user);
	         if (request.getParameter(ServiceParameters.OPERATION)
				.equals(GET_UNITS)) {			
			   DBJsonUtils.writeJSON(out, 
					   				new RealUnit(), 
					   				db.userUtil.getLastPositionsByUserNameRes(params.getUSER(),
					   													      params.getUnit_id()));
