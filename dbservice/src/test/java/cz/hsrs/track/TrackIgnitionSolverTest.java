...
public class TrackIgnitionSolverTest {
	...
	public void testInsertObservationsSynchro() throws SQLException, NoItemFoundException{
		...
		p1.insertToDb();		
		o1 = new Observation(d1, 0 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);		
		new TrackIgnitionSolver(o1).solve();
		
		p2.insertToDb();
		o2 = new Observation(d2, 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		...
		p3.insertToDb();
		o3 = new Observation(d3, 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o3).solve();
		Assert.assertEquals(3, u.getTrackLenght(d1.getGid()));
		
		p4.insertToDb();
		o4 = new Observation(d4, 0 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		...
		for (int i = 1; i < 4; i++){
			...
			p.insertToDb();
			Observation o = new Observation(d4, 0 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		...
		for (int i = 1; i < 4; i++){
			...
			p1.insertToDb();
			Observation o = new Observation(d4, 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
			new TrackIgnitionSolver(o).solve();				
		}
	...
	public void testAsynchro1() throws SQLException, NoItemFoundException{
		...
		p1.insertToDb();
		o1 = new Observation(p1.internalGetTime_stamp(), 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o1).solve();
		
		p2.insertToDb();
		o2 = new Observation(p2.internalGetTime_stamp(), 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o2).solve();							
		
		p5.insertToDb();
		o5 = new Observation(p5.internalGetTime_stamp(), 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o5).solve();
		
		p6.insertToDb();
		o6 = new Observation(p6.internalGetTime_stamp(), 1 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o6).solve();
		
		p4.insertToDb();
		o4 = new Observation(p4.internalGetTime_stamp(), 0 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o4).solve();
		
		p3.insertToDb();
		o3 = new Observation(p3.internalGetTime_stamp(), 0 , TrackIgnitionSolver.IGNITION_SENSOR_ID, unit_id);
		new TrackIgnitionSolver(o3).solve();			
