...
public class ObservationUtilTest {
    ...
    public void testInsertObservatation() throws SQLException{
        Date d = new Date();
        Observation obs = new Observation(d, 20.0, sensorId, unitId);
    ...
    public void testGetGid() throws SQLException, NoItemFoundException{
        pos1.insertToDb();    
        pos2.insertToDb();    
        Observation obs1 = new Observation(d1, 20.0, sensorId, unitId);
        util.insertObservation(obs1);
        Observation obs2 = new Observation(d2, 20.0, sensorId, unitId);
