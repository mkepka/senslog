...
public class VgiObservationRest {
        ...
        try {
            ...
            if(obsId == null){
                ...
                boolean inserted = orUtil.processUpdateVgiObs(obsId, timestampValue, catValue, descValue, attsValue,
                        unitIdValue, userName, datasetIdValue, lonValue, latValue, fileInStream, mediaType);
                return Response.ok(String.valueOf(inserted))
                        .header(HttpHeaders.CONTENT_TYPE, MediaType.TEXT_PLAIN)
                        .build();
            }
        } catch (Exception e) {
     ...
     * URL: /rest/vgi/observation/select?user_name=&format=&dataset_id=&category_id=&fromTime=&toTime=
     ...
     * URL: /rest/vgi/observation/{obs_vgi_id}/media/insert?user_name=
     ...
     * URL: /rest/vgi/observation/{obs_vgi_id}/media/list?user_name=
